...
SERVER_ADDRESS = ('0.0.0.0', 11000)  # create a socket that is listing to all ips
...
while True:
    ...
    try:
        ...
        f = open(filename[
                 1:])  # opening the file statrting from the 2nd char in the name (the name starts with \ and we dont want that)
